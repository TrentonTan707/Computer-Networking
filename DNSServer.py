...
dns_records = {
    ...
    'nyu.edu.':{
        ...
        dns.rdatatype.TXT: (str(generate_sha256_hash(input_string)),),
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    mName, rName, serial, refresh, retry, expire, timeToLive = answer_data # What is the record format? See dns_records dictionary. Assume we handle @, Class, TTL elsewhere. Do some research on SOA Records
                    rdata = SOA(dns.rdataclass.IN, dns.rdatatype.SOA, mName, rName, serial, refresh, retry, expire, timeToLive) # follow format from previous line
